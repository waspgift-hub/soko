...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      if (placemarks.isNotEmpty && mounted) {
        ...
        final city = place.locality ?? place.subAdministrativeArea ?? place.administrativeArea ?? 'Tanzania';
  ...
  Future<void> _submit() async {
    ...
    final isFreeUser = profile?.isFree ?? true;

    if (isFreeUser && !_isEditing) {
      final adShown = await _showRewardedAdGate();
      if (!adShown) return;
    }
      ...
      if (_isEditing) {
        ...
        await _productService.addProduct(
          ...
          brand: _brandController.text.isNotEmpty
              ...
              : null,
          condition: _selectedCondition,
          location: _locationController.text.isNotEmpty ? _locationController.text : 'Tanzania',
        );
      }
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Expanded(child: Text(tr('watch_ad'))),
          ],
        ),
        content: Column(
