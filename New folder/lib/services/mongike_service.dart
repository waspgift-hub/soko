...
class MongikeService {
  ...
  static Future<Map<String, dynamic>> initiateMarketplacePayment({
    ...
    try {
      ...
      debugPrint('Mongike: status ${resp.statusCode} body ${resp.body}');
      if (resp.statusCode != 200) {
        debugPrint('Mongike: non-200 response');
  ...
  static Future<int> getBalance() async {
    try {
      final resp = await http.get(
        Uri.parse('${ApiConfig.baseUrl}/api/mongike/balance'),
      );
