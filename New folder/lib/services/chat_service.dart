  ...
  Future<void> sendMessage({
    ...
    try {
      ...
      if (receiverDoc.exists) {
        ...
        receiverName = (rData?['displayName'] as String?)?.isNotEmpty == true
            ? rData!['displayName'] as String
            : (rData?['email'] as String?)?.split('@').first ?? '';
      }
    } catch (_) {}
    ...
    await _db.collection("conversations").doc(conversationId).set({
      ...
      'participantNames': { _uid: senderName, receiverId: receiverName },
