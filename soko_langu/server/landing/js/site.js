(function () {
  ...
  var I18N = {
    sw: {
      ...
      cat_sneakers: 'Viatu',
      cat_electronics: 'Elektroniki',
      cat_phones: 'Simu',
      cat_home: 'Nyumbani',
      escrow_badge: 'ESCROW',
      metric_sellers: 'Wauzaji',
      metric_listings: 'Machapisho',
      metric_escrow: 'ESCROW',
      metric_volume: 'Kiasi cha mauzo',
    ...
    en: {
      ...
      cat_home: 'Home',
      escrow_badge: 'ESCROW',
      metric_sellers: 'Sellers',
      metric_listings: 'Listings',
      metric_escrow: 'ESCROW',
      metric_volume: 'Sales volume',
      hero_eyebrow: 'Soko Vibe · Dar es Salaam, Tanzania',
      hero_h1: 'Soko Vibe — Tanzania Online Marketplace',
