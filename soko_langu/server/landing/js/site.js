(function () {
  ...
  var I18N = {
    sw: {
      ...
      nav_sifa: 'Sifa', nav_jinsi: 'Jinsi Inavyofanya Kazi', nav_bei: 'Bei za Boost',
      ...
      f5_t: 'Zana za wauzaji', f5_b: 'Orodha za bure, boost za bei nafuu, flash sales, takwimu za wakati halisi na usimamizi wa duka — vyote kwenye dashboard moja.',
      ...
      price_eyebrow: 'Bei za boost', price_h2: 'Orodha ni bure. Boosta unapotaka kuonekana zaidi.',
      price_lead: 'Hulipi kamwe kufungua orodha. Unalipa tu unapochagua kuiboresha ili ione kwa watu zaidi.',
      p_bronze_d: 'kwa orodha moja · siku 3', p_bronze_f: 'Kujulikana haraka kwa orodha mpya au inayoisha.',
      p_popular: 'Nyakati nyingi',
      p_silver_d: 'kwa orodha moja · siku 7', p_silver_f: 'Wiki nzima ya kuonekana zaidi ndani ya app.',
      p_gold_d: 'kwa orodha moja · siku 30', p_gold_f: 'Ufikiaji mkubwa kwa bidhaa yako bora, mwezi mzima.',
      price_note: 'Bei zote ni za shilingi za Tanzania. Boost unafanya kwenye app — hakuna mkataba wa kudumu, hakuna usajili.',
      li1: 'Kuweka orodha ni bure — unalipa tu unapoboost',
      ...
      q1: 'Je, kuweka bidhaa ni bure kweli?', a1: 'Ndiyo. Kufungua orodha haina gharama yoyote. Unalipa tu unapochagua ku-boost orodha yako ili ione kwa watu zaidi.',
    ...
    en: {
      ...
      nav_sifa: 'Features', nav_jinsi: 'How It Works', nav_bei: 'Boost Prices',
      ...
      f5_t: 'Seller tools', f5_b: 'Free listings, affordable boosts, flash sales, real-time stats, and shop management — all in one dashboard.',
      ...
      price_eyebrow: 'Boost prices', price_h2: 'Listing is free. Boost when you want more visibility.',
      price_lead: 'You never pay to open a listing. You only pay when you choose to boost it so more people see it.',
      p_bronze_d: 'per listing · 3 days', p_bronze_f: 'Quick visibility for new or expiring listings.',
      p_popular: 'Most popular',
      p_silver_d: 'per listing · 7 days', p_silver_f: 'A full week of extra visibility inside the app.',
      p_gold_d: 'per listing · 30 days', p_gold_f: 'Maximum reach for your best product, all month.',
      price_note: 'All prices are in Tanzanian shillings. You boost inside the app — no long-term contract, no subscription.',
      li1: 'Listing is free — you only pay when you boost',
      ...
      q1: 'Is listing products really free?', a1: 'Yes. Opening a listing costs nothing. You only pay when you choose to boost your listing so more people see it.',
