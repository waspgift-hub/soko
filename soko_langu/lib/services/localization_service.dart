...
class LocalizationService {
  ...
  static final Map<String, Map<String, String>> translations = {
    'sw': {
      ...
      'buy_now': 'Nunua Sasa',
      'quantity': 'Idadi',
      'minimum_order_x': 'Kiwango cha chini ni {0}',
      'only_x_left': 'Zimebaki {0} tu',
      'in_stock_x': 'Zipo ({0})',
      ...
      'submit_kyc': 'Tuma KYC',
      'kyc_first_name': 'Jina la Kwanza',
      'kyc_middle_name': 'Jina la Kati',
      'kyc_last_name': 'Jina la Ukoo',
      'kyc_dob_label': 'Tarehe ya Kuzaliwa',
      'kyc_dob_hint': 'Chagua tarehe uliyozaliwa',
      'kyc_address_label': 'Anwani',
      'kyc_address_hint': 'Mtaa, Eneo, Wilaya',
      'kyc_phone_label': 'Namba ya Simu',
      'kyc_email_label': 'Barua pepe (Email)',
      ...
      'kyc_enter_middle_name': 'Tafadhali jaza jina lako la kati',
      'kyc_enter_last_name': 'Tafadhali jaza jina lako la ukoo',
      'kyc_enter_dob': 'Tafadhali chagua tarehe ya kuzaliwa',
      'kyc_enter_address': 'Tafadhali jaza anwani yako',
      ...
      'kyc_fee_one_time': 'Mara moja tu — haitakiwi tena hata KYC ikikataliwa.',
      'kyc_fee_paid': 'Ada Imelipwa',
      'kyc_fee_paid_desc': 'Ada imelipwa. Sasa unaweza kutuma KYC yako.',
      'kyc_fee_pay_button': 'Lipa TZS {0}',
      ...
      'kyc_fee_control_number_label': 'Namba ya Control',
      'kyc_fee_billpay_instructions':
      ...
      'minutes': 'Dakika',
      'mute': 'Nyamazisha',
      'no_received_orders': 'Bado hujapokea maagizo yoyote',
      ...
      'storage': 'Hifadhi',
    'filters': 'Vichujio',
    'popular_filters': 'Vichujio Maarufu',
    'size': 'Saizi',
    'color': 'Rangi',
    'ram': 'RAM',
    'processor': 'Prosesaa',
    ...
    'no_brands_found': 'Hakuna chapa iliyopatikana',
    'popular_categories': 'Kategoria Maarufu',
    'all_categories': 'Kategoria Zote',
    'search_categories_hint': 'Unatafuta nini?',
      ...
      // v2 Trust-Commerce statuses
      'draft_label': 'Rasimu',
      'published_label': 'Imechapishwa',
      'address_required_label': 'Anwani Inahitajika',
      'pending_shipping_fee_label': 'Inasubiri Gharama ya Usafirishaji',
      'shipping_fee_submitted_label': 'Gharama Imewasilishwa',
      'shipping_fee_review_label': 'Gharama Inakaguliwa',
      'awaiting_escrow_payment_label': 'Inasubiri Malipo ya Escrow',
      ...
      'verdict_normal': 'Bei ya usafirishaji ni ya haki.',
      'verdict_review': 'Inahitaji ukaguzi — bei iko juu kuliko kawaida kwa umbali huu.',
      'verdict_blocked': 'Bei imewekewa alama ya hatari — tafadhali wasiliana na msaada.',
      'tp_title': 'Trust ya Muuzaji',
      'tp_score': 'Alama ya Kuaminiwa',
      'tp_verified': 'Imethibitishwa',
      'tp_unverified': 'Haijathibitishwa',
      'tp_disclaimer': 'Hutengenezwa kutokana na miamala yake ya escrow.',
      'tp_identity_verified': 'Utambulisho umehakikiwa',
      'tp_fulfillment': 'Utekelezaji wa mauzo',
      'tp_dispatch_punctuality': 'Usafirishaji wa wakati',
      'tp_dispute_behavior': 'Tabia ya migogoro',
      'dispute_why': 'Ni kwa nini unafungua mgogoro?',
      'dispute_evidence': 'Ushahidi (kwa hiari, hadi picha 3)',
      'dispute_reason_not_received': 'Sijapokea mzigo',
      'dispute_reason_damaged': 'Mzigo umefika umeharibika',
      'dispute_reason_not_as_described': 'Bidhaa si kama ilivyotangazwa',
      'dispute_reason_other': 'Nyingine',
      'dispute_other_hint': 'Andika kilichotokea...',
      'dispute_submit': 'Fungua Mgogoro',
      ...
      'ready_to_dispatch_label': 'Tayari Kufikishwa',
      'in_transit_label': 'Njiani',
      'out_for_delivery_label': 'Inaelekea Kufikishwa',
      'delivery_attempted_label': 'Kujaribu Kufikisha',
      'inspection_period_label': 'Kipindi cha Ukaguzi',
      'otp_pending_label': 'Inasubiri OTP',
      'wallet_credited_label': 'Imeingizwa kwenye Wallet',
      'payout_pending_label': 'Malipo kwa Muuzaji Yanachakatwa',
      'payout_complete_label': 'Malipo Yamekamilika',
      'refund_pending_label': 'Kurudisha Hela Kunasubiri',
      'payment_processing_label': 'Malipo Yanachakatwa',
      'payment_failed_label': 'Malipo Yameshindikana',
      'escrow_held_label': 'Imehifadhiwa kwenye Escrow',
      'seller_accepted_label': 'Muuzaji Amekubali',
      'dispatch_ready_label': 'Tayari Kufikishwa',
      ...
      'ai_dalali': 'AI Dalali',
      'ai_label': 'AI',
      'ai_summarizing': 'AI Dalali anachambua matokeo…',
      'sort_best_match': 'Lingana Bora',
      'sort_price_low': 'Bei: Chini',
      'sort_price_high': 'Bei: Juu',
      'suggested_for_you': 'Unaweza kutafuta',
      'suggested_q1': 'simu chini ya 800k',
      'suggested_q2': 'kompyuta ndogo',
      'suggested_q3': 'gari',
      ...
      'view_cart': 'Tazama Troli',
      'cart_title': 'Troli',
      'clear_cart': 'Futa Troli',
      ...
      'age': 'Umri',
      'boosts': 'Matangazo',
      'sponsored_campaign': 'Kampeni Iliyodhaminiwa',
      'sponsored_campaigns': 'Vikampeni Viliyodhaminiwa',
      'sponsored_dashboard': 'Bodi ya Kampeni Viliyodhaminiwa',
      'sponsored_listing': 'Bidhaa Iliyodhaminiwa',
      'sponsored_performance': ' Utendaji wa Kampeni',
      'create_sponsored_campaign': 'Anzisha Kampeni Iliyodhaminiwa',
      'create_campaign': 'Anzisha Kampeni',
      'create_first_campaign': 'Anzisha Kampeni Yako ya Kwanza',
      'no_sponsored_campaigns': 'Hakuna vikampeni viliyodhaminiwa bado',
      'my_campaigns': 'Vikampeni Vyangu',
      'active_campaigns': 'Vikampeni Vya Tayari',
      'draft_campaigns': 'Vikampeni Vya Rasimu',
      'campaign_details': 'Maelezo ya Kampeni',
      'campaign_created': 'Kampeni imetengenezwa',
      'campaign_saved': 'Kampeni imesaheliwa',
      'campaign_updated': 'Kampeni imeoratibuswa',
      'campaign_status': 'Hali ya Kampeni',
      'campaign_active': 'Tayari',
      'campaign_draft': 'Rasimu',
      'campaign_pending_payment': 'Inasubiri Malipo',
      'campaign_paused': 'Imestop',
      'campaign_completed': 'Imekamilika',
      'campaign_cancelled': 'Imeghairiwa',
      'campaign_rejected': 'Imekataliwa',
      'campaign_expired': 'Imeisha Muda',
      'campaign_out_of_budget': 'Bajeti Imetumika',
      'admin_sponsored_settings': 'Mipangilio ya Matangazo',
      'admin_min_budget': 'Bajeti ya Chini',
      'admin_max_budget': 'Bajeti ya Juu',
      'admin_min_duration': 'Muda wa Chini',
      'admin_max_duration': 'Muda wa Juu',
      'admin_placement_config': 'Mipangilio ya Mahali',
      'admin_pricing_config': 'Mipangilio ya Bei',
      'admin_campaign_actions': 'Vitendo vya Kampeni',
      'admin_approve_campaign': 'Idhinisha Kampeni',
      'admin_reject_campaign': 'Kataa Kampeni',
      'admin_pause_campaign': 'Simamisha Kampeni',
      'admin_resume_campaign': 'Endeleza Kampeni',
      'admin_end_campaign': 'Maliza Kampeni',
      'admin_audit_log': 'Kumbukumbu za Ukaguzi',
      'admin_total_campaigns': 'Jumla ya Kampeni',
      'admin_pending_campaigns': 'Kampeni Zinazosubiri',
      'admin_rejected_campaigns': 'Kampeni Zilizokataliwa',
      'admin_reject_reason': 'Sababu ya Kukataa (hiari)',
      'admin_settings_saved': 'Mipangilio imehifadhiwa',
      'admin_no_campaigns': 'Hakuna kampeni zilizopatikana',
      'admin_filter_all': 'Zote',
      'admin_sweep_now': 'Sasisha Hali Sasa',
      'admin_store': 'Duka',
      'admin_actions': 'Vitendo',
      'admin_action_done': 'Imefanyika',
      'admin_campaigns': 'Kampeni',
      'cancel_campaign': 'Ghairi Kampeni',
      'cancel_campaign_confirmation': ' Je, una dhihirisha unataka kughairi kampeni hii?',
      'placements': ' Mahali',
      'placement': 'Mahali',
      'budget': 'Bajeti',
      'campaign_budget': 'Bajeti ya Kampeni',
      'budget_tier': 'Kiwango',
      'budget_presets': ' Viperizo vya Bajeti',
      'budget_used': 'Bajeti iliyotumika',
      'custom_budget': ' Bajeti Yenye Utambuzi',
      'daily_budget': 'Bajeti ya Leo',
      'total_budget': 'Jumla ya Bajeti',
      'bid_amount': 'Kiasi cha Zabuni',
      'bid_amount_per_impression': 'Kiasi cha Zabuni kwa Muonekano',
      'estimated_total': 'Jumla iliyopendekezwa',
      'target_products': 'Bidhaa Zilizohamlishwa',
      'all_my_products': 'Bidhaa Zangu Zote',
      'no_products_available': 'Hakuna bidhaa zinazopatikana',
      'create_and_pay': 'Tengeneza na Lipia',
      'campaign_name': 'Jina la Kampeni',
      'campaign_name_hint': 'k.m. "Ofa ya Mwaka Kipindani"',
      'days_abbr': 'd',
      'payment_status': 'Hali ya Malipo',
      'payment_initiated': 'Malipo yameanza!',
      'pay_and_activate': 'Lipa na Uwimilie',
      'billpay_method': 'Bili ya Malipo',
      'spend': 'Matumia',
      'total_spend': 'Jumla ya Matumia',
      'daily_spend': 'Matumia ya Leo',
      'impressions': 'mara zilizoonekana',
      'impressions_count': 'Maonekano',
      'clicks': 'Vidokezo',
      'clicks_count': 'Vidokezo',
      'ctr': 'CTR',
      'cpc': 'CPC',
      'cpm': 'CPM',
      'performance_over_time': 'Utendaji kwa Muda',
      'last_days': 'Mara ya',
      'no_metrics_yet': 'Hakuna takwimu bado',
      'insufficient_budget': 'Bajeti haitoshi',
      'invalid_dates': 'Tarehe zisizo sahihi',
      // ── Campaign Creation Flow (5 Steps) ──
      'campaign_creation_step1_title': 'Chagua Bidhaa ya Kuanzisha Kampeni',
      'campaign_creation_step1_desc': 'Chagua bidhaa unayotaka kuonyesha kwa wanunuzi zaidi.',
      'campaign_creation_step2_title': 'Unataka Kuboresha Nini?',
      'campaign_creation_step2_desc': 'Chagua lengo la kampeni yako.',
      'campaign_creation_step3_title': 'Chagua Mahali pa Kuonekana',
      'campaign_creation_step3_desc': 'Chagua mahali ambapo bidhaa yako itaonekana.',
      'campaign_creation_step4_title': 'Muda wa Kampeni',
      'campaign_creation_step4_desc': 'Chagua mda uliotaka kampeni iendelee.',
      'campaign_creation_step5_title': 'Bajeti ya Kampeni',
      'campaign_creation_step5_desc': 'Weka kiasi unachotaka kitumia.',
      // ── Campaign Objectives ──
      'objective_increase_visibility': 'Ongeza Uonekano',
      'objective_increase_visibility_desc': 'Onyesha bidhaa yako kwa wanunuzi zaidi.',
      'objective_reach_relevant_shoppers': 'Fikia Wanunuzi Wenye Husika',
      'objective_reach_relevant_shoppers_desc': 'Fikia watu wakitafuta au wakizunguka bidhaa kama yako.',
      'objective_promote_new_product': 'Anezisha Bidhaa Mpya',
      'objective_promote_new_product_desc': 'Pa bidhaa mpya uonekano zaidi wa kawaida.',
      // ── Placement Types ──
      'placement_sponsored_search': 'Utafutaji Iliyodhaminiwa',
      'placement_sponsored_category': 'Kategoria Iliyodhaminiwa',
      'placement_sponsored_recommendations': 'Mapendekezo Iliyodhaminiwa',
      'placement_sponsored_product_feed': 'Feed ya Bidhaa Iliyodhaminiwa',
      'placement_sponsored_store_discovery': 'Gundu la Duka Iliyodhaminiwa',
      'placement_featured_sponsored': 'Naibu ya Kupitia Uangalizi',
      // ── Duration Options ──
      'duration_1_day': 'Siku 1',
      'duration_3_days': 'Siku 3',
      'duration_7_days': 'Siku 7',
      'duration_14_days': 'Siku 14',
      'duration_30_days': 'Siku 30',
      // ── Budget Terminology ──
      'set_campaign_budget': 'Weka Bajeti ya Kampeni',
      'choose_budget_amount': 'Chagua kiasi unachotaka kitumia.',
      'budget_tier_bronze': 'Bronze',
      'budget_tier_silver': 'Silver',
      'budget_tier_gold': 'Gold',
      'custom_budget_label': 'Bajeti ya Kipekee',
      'you_control_campaign_budget': 'Wewe unawaliza bajeti yako ya kampeni.',
      // ── Campaign Summary ──
      'campaign_summary_title': 'Kampeni Iliyodhaminiwa',
      'campaign_summary_product': 'Bidhaa',
      'campaign_summary_objective': 'Lengo',
      'campaign_summary_placements': 'Mahali',
      'campaign_summary_duration': 'Muda',
      'campaign_summary_budget': 'Bajeti ya Kampeni',
      'campaign_summary_note': 'Kampeni yako itaanza baada ya malipo mafanyika na uthibitisho wa uhalali.',
      'start_sponsored_campaign_cta': 'Anzisha Kampeni Iliyodhaminiwa',
      // ── Dashboard ──
      'sponsored_dashboard_title': 'Bodi ya Kupitia Uangalizi',
      'status_active_desc': 'Kampeni yako iliyodhaminiwa inaendelea sasa.',
      'status_paused_desc': 'Kampeni yako imesimamishwa. Uangalizi hauko tayari.',
      'status_completed_desc': 'Kampeni yako imekamilika.',
      'status_pending_payment_desc': 'Kamilisha malipo kuwamilisha kampeni yako.',
      'status_rejected_desc': 'Kampeni yako haikubaliwa kwa uangalizi.',
      'status_out_of_budget_desc': 'Bajeti ya kampeni yako imetumika kikamilifu.',
      // ── Analytics ──
      'analytics_visibility': 'Uonekano',
      'analytics_engagement': 'Ushirikiano',
      'analytics_commercial_results': 'Matokeo ya Biashara',
      'analytics_spending': 'Matumizi',
      'analytics_impressions': 'Maonekano',
      'analytics_clicks': 'Vidokezo',
      'analytics_ctr': 'CTR (Kiwango cha Vidokezo)',
      'analytics_product_views': 'Maonekano ya Bidhaa',
      'analytics_orders_attributed': 'Oda Zilizohusishwa',
      'analytics_revenue_attributed': 'Mapato Yaliyohusishwa',
      'analytics_budget': 'Bajeti',
      'analytics_amount_spent': 'Iliyotumiwa',
      'analytics_remaining_budget': 'Bajeti Ilibaki',
      'attribution_disclaimer': 'Uangalizi huongeza uonekano. Hautoi dhamana mauzo. Oda zilizohusishwa hazimaanishi kuwa zote zimefanywa na matangazo.',
      // ── Professional Copy ──
      'increase_visibility_copy': 'Ongeza uonekano wa bidhaa yako.',
      'reach_more_shoppers_copy': 'Fikia wanunuzi zaidi kupitia uangalizi.',
      'promote_product_copy': 'Weka bidhaa yako kwenye nafasi za kupitia uangalizi.',
      'run_7_day_campaign_copy': 'Endesha kampeni ya siku 7 iliyodhaminiwa.',
      'start_sponsored_campaign_copy': 'Anzisha Kampeni Iliyodhaminiwa',
      'give_more_opportunities_copy': 'Pa bidhaa yako fursa zaidi za kugunduliwa.',
      // ── Sponsored Label ──
      'sponsored_label': 'Iliyodhaminiwa',
      'sponsored_product': 'Bidhaa Iliyodhaminiwa',
      'successful': 'Imefaulu',
      ...
      'msg_waiting_connection': 'Inasubiri mtandao',
      ...
      'otp_copied': 'OTP imekopieshwa',
      'enter_buyer_otp': 'Weka nambari ya uthibitisho kutoka kwa mnunuzi',
      'otp_attempts_remaining': 'Majaribio yaliyobaki: {0}',
      'verify_and_release': 'Thibitisha na Utoe Fedha',
      'verifying_label': 'Inathibitisha...',
      'otp_verified_success': 'OTP imethibitishwa. Oda imekamilika.',
      'otp_verification_failed': 'OTP si sahihi. Tafadhali jaribu tena.',
    ...
    'en': {
      ...
      'buy_now': 'Buy Now',
      'quantity': 'Quantity',
      'minimum_order_x': 'Minimum order is {0}',
      'only_x_left': 'Only {0} left',
      'in_stock_x': 'In stock ({0})',
      ...
      'kyc_dob_hint': 'Select your date of birth',
      'kyc_address_label': 'Address',
      'kyc_address_hint': 'Street, Area, District',
      'kyc_phone_label': 'Phone Number',
      'kyc_email_label': 'Email',
      ...
      'kyc_enter_dob': 'Please select your date of birth',
      'kyc_enter_address': 'Please enter your address',
      'kyc_enter_phone': 'Please enter your phone number',
      ...
      'kyc_fee_control_number_label': 'Control Number',
      'kyc_fee_billpay_instructions':
      ...
      'shortcut_not_supported': 'Shortcut could not be added to home screen',
    ...
    'search_categories_hint': 'What are you looking for?',
      ...
      'address_required_label': 'Address Required',
      'pending_shipping_fee_label': 'Awaiting Shipping Cost',
      'shipping_fee_submitted_label': 'Shipping Cost Submitted',
      'shipping_fee_review_label': 'Shipping Cost Under Review',
      'awaiting_escrow_payment_label': 'Awaiting Escrow Payment',
      ...
      'verdict_normal': 'Shipping cost looks fair.',
      'verdict_review': 'Needs review - above the typical range for this distance.',
      'verdict_blocked': 'Flagged - unusually high. Contact support.',
      'tp_title': 'Seller Trust Passport',
      'tp_score': 'Trust Score',
      'tp_verified': 'Verified',
      'tp_unverified': 'Not verified',
      'tp_disclaimer': 'Built from the seller\'s escrow history.',
      'tp_identity_verified': 'Identity Verified',
      'tp_fulfillment': 'Order Fulfillment',
      'tp_dispatch_punctuality': 'On-Time Dispatch',
      'tp_dispute_behavior': 'Dispute Behavior',
      'dispute_why': 'Why are you opening a dispute?',
      'dispute_evidence': 'Evidence (optional, up to 3 photos)',
      'dispute_reason_not_received': "I didn't receive the item",
      'dispute_reason_damaged': 'Item arrived damaged',
      'dispute_reason_not_as_described': 'Item not as described',
      'dispute_reason_other': 'Other',
      'dispute_other_hint': 'Describe what happened...',
      ...
      'delivery_attempted_label': 'Delivery Attempted',
      'inspection_period_label': 'Inspection Period',
      'otp_pending_label': 'Awaiting OTP',
      'wallet_credited_label': 'Wallet Credited',
      'payout_pending_label': 'Payout Pending',
      'payout_complete_label': 'Payout Complete',
      'refund_pending_label': 'Refund Pending',
      'payment_processing_label': 'Payment Processing',
      'payment_failed_label': 'Payment Failed',
      'escrow_held_label': 'Held in Escrow',
      'seller_accepted_label': 'Seller Accepted',
      'dispatch_ready_label': 'Ready to Dispatch',
      'paying_label': 'Paying...',
      ...
      'ai_dalali': 'AI Dalali',
      'ai_label': 'AI',
      'ai_summarizing': 'AI is analyzing results…',
      'sort_best_match': 'Best Match',
      'sort_price_low': 'Lowest Price',
      'sort_price_high': 'Highest Price',
      'suggested_for_you': 'Try searching',
      'suggested_q1': 'phone under 800k',
      'suggested_q2': 'cheap laptop',
      'suggested_q3': 'car',
      ...
      'sponsored_dashboard': 'Sponsored Dashboard',
      'sponsored_listing': 'Sponsored Listing',
      'sponsored_performance': 'Campaign Performance',
      'create_sponsored_campaign': 'Create Sponsored Campaign',
      'create_campaign': 'Create Campaign',
      'create_first_campaign': 'Create Your First Campaign',
      'no_sponsored_campaigns': 'No sponsored campaigns yet',
      ...
      'campaign_pending_payment': 'Pending Payment',
      'campaign_paused': 'Paused',
      'campaign_completed': 'Completed',
      'campaign_cancelled': 'Cancelled',
      'campaign_rejected': 'Rejected',
      'campaign_expired': 'Expired',
      'campaign_out_of_budget': 'Budget Exhausted',
      'admin_sponsored_settings': 'Sponsored Settings',
      'admin_min_budget': 'Minimum Budget',
      'admin_max_budget': 'Maximum Budget',
      'admin_min_duration': 'Minimum Duration',
      'admin_max_duration': 'Maximum Duration',
      'admin_placement_config': 'Placement Configuration',
      'admin_pricing_config': 'Pricing Configuration',
      'admin_campaign_actions': 'Campaign Actions',
      'admin_approve_campaign': 'Approve Campaign',
      'admin_reject_campaign': 'Reject Campaign',
      'admin_pause_campaign': 'Pause Campaign',
      'admin_resume_campaign': 'Resume Campaign',
      'admin_end_campaign': 'End Campaign',
      'admin_audit_log': 'Audit Log',
      'admin_total_campaigns': 'Total Campaigns',
      'admin_pending_campaigns': 'Pending Campaigns',
      'admin_rejected_campaigns': 'Rejected Campaigns',
      'admin_reject_reason': 'Rejection Reason (optional)',
      'admin_settings_saved': 'Settings saved',
      'admin_no_campaigns': 'No campaigns found',
      'admin_filter_all': 'All',
      'admin_sweep_now': 'Reconcile Statuses',
      'admin_store': 'Store',
      'admin_actions': 'Actions',
      'admin_action_done': 'Done',
      'admin_campaigns': 'Campaigns',
      'cancel_campaign': 'Cancel Campaign',
      'cancel_campaign_confirmation': 'Are you sure you want to cancel this campaign?',
      ...
      'bid_amount_per_impression': 'Bid Amount per impression',
      'estimated_total': 'Estimated Total',
      'target_products': 'Target Products',
      'all_my_products': 'All My Products',
      'no_products_available': 'No products available',
      'create_and_pay': 'Create & Pay',
      'campaign_name': 'Campaign Name',
      'campaign_name_hint': 'e.g. "Back to School Sale"',
      'days_abbr': 'd',
      'payment_status': 'Payment Status',
      'payment_initiated': 'Payment initiated!',
      'pay_and_activate': 'Pay & Activate',
      'billpay_method': 'BillPay',
      'spend': 'Spend',
      ...
      // ── Campaign Creation Flow (5 Steps) ──
      'campaign_creation_step1_title': 'Choose a Product to Sponsor',
      'campaign_creation_step1_desc': 'Select a product you want to promote to more shoppers.',
      'campaign_creation_step2_title': 'What would you like to improve?',
      'campaign_creation_step2_desc': 'Choose the objective for your campaign.',
      'campaign_creation_step3_title': 'Choose Where to Appear',
      'campaign_creation_step3_desc': 'Select where your product should appear.',
      'campaign_creation_step4_title': 'Campaign Duration',
      'campaign_creation_step4_desc': 'Choose how long you want the campaign to run.',
      'campaign_creation_step5_title': 'Campaign Budget',
      'campaign_creation_step5_desc': 'Set how much you want to spend.',
      // ── Campaign Objectives ──
      'objective_increase_visibility': 'Increase Visibility',
      'objective_increase_visibility_desc': 'Show your product to more shoppers.',
      'objective_reach_relevant_shoppers': 'Reach Relevant Shoppers',
      'objective_reach_relevant_shoppers_desc': 'Reach people browsing or searching for products like yours.',
      'objective_promote_new_product': 'Promote a New Product',
      'objective_promote_new_product_desc': 'Give a newly listed product additional exposure.',
      // ── Placement Types ──
      'placement_sponsored_search': 'Sponsored Search',
      'placement_sponsored_category': 'Sponsored Category',
      'placement_sponsored_recommendations': 'Sponsored Recommendations',
      'placement_sponsored_product_feed': 'Sponsored Product Feed',
      'placement_sponsored_store_discovery': 'Sponsored Store Discovery',
      'placement_featured_sponsored': 'Featured Sponsored Placement',
      // ── Duration Options ──
      ...
      // ── Budget Terminology ──
      'set_campaign_budget': 'Set your campaign budget',
      'choose_budget_amount': 'Choose how much you\'d like to spend.',
      'budget_tier_bronze': 'Bronze',
      'budget_tier_silver': 'Silver',
      'budget_tier_gold': 'Gold',
      'custom_budget_label': 'Custom Budget',
      'you_control_campaign_budget': 'You control your campaign budget.',
      // ── Campaign Summary ──
      'campaign_summary_title': 'Sponsored Campaign',
      'campaign_summary_product': 'Product',
      'campaign_summary_objective': 'Objective',
      'campaign_summary_placements': 'Placements',
      'campaign_summary_duration': 'Duration',
      'campaign_summary_budget': 'Campaign Budget',
      'campaign_summary_note': 'Your campaign will begin after successful payment and eligibility checks.',
      'start_sponsored_campaign_cta': 'Start Sponsored Campaign',
      // ── Dashboard ──
      'sponsored_dashboard_title': 'Sponsored Dashboard',
      'status_active_desc': 'Your Sponsored Campaign is currently running.',
      'status_paused_desc': 'Your campaign is paused. Sponsored placement is temporarily inactive.',
      'status_completed_desc': 'Your campaign has ended.',
      'status_pending_payment_desc': 'Complete payment to activate your campaign.',
      'status_rejected_desc': 'Your campaign could not be approved for sponsored placement.',
      'status_out_of_budget_desc': 'Your campaign budget has been fully used.',
      // ── Analytics ──
      'analytics_visibility': 'Visibility',
      'analytics_engagement': 'Engagement',
      'analytics_commercial_results': 'Commercial Results',
      'analytics_spending': 'Spending',
      'analytics_impressions': 'Impressions',
      'analytics_clicks': 'Clicks',
      'analytics_ctr': 'CTR (Click-Through Rate)',
      'analytics_product_views': 'Product Views',
      'analytics_orders_attributed': 'Attributed Orders',
      'analytics_revenue_attributed': 'Attributed Revenue',
      'analytics_budget': 'Budget',
      'analytics_amount_spent': 'Amount Spent',
      'analytics_remaining_budget': 'Remaining Budget',
      'attribution_disclaimer': 'Sponsored placement increases visibility. It does not guarantee sales. Attributed orders may not reflect all product orders.',
      // ── Professional Copy ──
      'increase_visibility_copy': 'Increase your product\'s visibility.',
      'reach_more_shoppers_copy': 'Promote your product to reach more shoppers.',
      'promote_product_copy': 'Put your product in sponsored placements.',
      'run_7_day_campaign_copy': 'Run a 7-day Sponsored Campaign.',
      'start_sponsored_campaign_copy': 'Start Sponsored Campaign',
      'give_more_opportunities_copy': 'Give your product more opportunities to be discovered.',
      // ── Sponsored Label ──
      ...
      'msg_waiting_connection': 'Waiting for connection',
      ...
      'verify_and_release': 'Verify & Release Funds',
      'verifying_label': 'Verifying...',
      'otp_verified_success': 'OTP verified. Order completed.',
