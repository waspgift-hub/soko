...
class _MyAdsScreenState extends State<MyAdsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) return Scaffold(body: Center(child: Text(context.tr('login_required'))));
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("${context.currencySymbol()}${product.price.toStringAsFixed(0)}",
