...
class ShopCustomizationScreen extends StatefulWidget {
  ...
  @override
  State<ShopCustomizationScreen> createState() => _ShopCustomizationScreenState();
}
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ..._presetColors().map((c) {
                    final selected =
                        themeManager.seedColor.toARGB32() == c.toARGB32();
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: selected
                            ? Icon(Icons.check, color: cs.surface, size: 24)
                            : null,
                      ),
                    );
                  }),
