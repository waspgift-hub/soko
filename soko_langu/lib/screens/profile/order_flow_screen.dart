              ...
              _InfoCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SubHeader(cs: cs, text: isEn ? 'TanQR / Lipa Namba' : 'TanQR / Lipa Namba'),
                    _PctRow(cs: cs, label: isEn ? 'Fee charged to merchant' : 'Ada inayotozwa kwa mfanyabiashara', value: '2%'),
                    const SizedBox(height: 10),
                    _SubHeader(cs: cs, text: isEn ? 'Card (Mastercard/Visa/UnionPay)' : 'Kadi (Mastercard/Visa/UnionPay)'),
                    _PctRow(cs: cs, label: isEn ? 'Fee charged to customer' : 'Ada inayotozwa kwa mteja', value: '4.85%'),
                    const SizedBox(height: 10),
              ...
              _InfoCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _PctRow(cs: cs, label: isEn ? 'Deposit via Lipa Namba' : 'Kuweka kwa Lipa Namba', value: '2%'),
                    const SizedBox(height: 10),
                    ...
                    const SizedBox(height: 10),
                    _SubHeader(cs: cs, text: isEn ? 'Lipa Namba / Card / BillPay' : 'Lipa Namba / Kadi / BillPay'),
                    _PctRow(cs: cs, label: isEn ? 'Gateway fee (percentage)' : 'Ada ya malipo (asilimia)', value: '2% / 4.85% / 1%'),
                    _PctRow(cs: cs, label: isEn ? 'Soko Vibe commission' : 'Ada ya Soko Vibe', value: '3.5%'),
                    const SizedBox(height: 16),
