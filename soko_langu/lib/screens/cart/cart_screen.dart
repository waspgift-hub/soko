...
class _CartScreenState extends State<CartScreen> {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    context.tr('send_payment_to_sellers'),
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(
                                      '${context.tr('seller_label')}: ${profile?.displayName ?? sid}',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                ...
                                ...sellerItems.map(
                                  (item) => Padding(
                                    ...
                                    child: Text(
                                      '${item.name} x${item.quantity} = TSh ${item.totalPrice.toStringAsFixed(0)}',
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  '${context.tr('subtotal')}: TSh ${sellerTotal.toStringAsFixed(0)}',
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                if (profile != null) ...[
                                  ...
                                  if (profile.phone.isNotEmpty)
                                    Text(
                                      '${context.tr('phone_label')}: ${profile.phone}',
                                      style: const TextStyle(fontSize: 13),
                                    ),
                                  ...profile.paymentNumbers.entries.map(
                                    (e) => Text(
                                      '${e.key}: ${e.value}',
                                      style: const TextStyle(fontSize: 13),
                                    ),
                  ...
                  Container(
                    ...
                    child: Text(
                      context.tr('send_money_instructions'),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pop(ctx);
                        _placeOrders(sellerGroups, sellerProfiles);
                      },
                      child: Text(
                        'Place Orders (${sellerGroups.length})',
  ...
  Future<void> _placeOrders(
    Map<String, List<CartItem>> sellerGroups,
    Map<String, UserProfile?> sellerProfiles,
  ) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        messenger.showSnackBar(
          SnackBar(content: Text('$count ${context.tr('orders_placed')}')),
        );
